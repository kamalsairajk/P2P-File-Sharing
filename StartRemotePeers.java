	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 0; i < myStart.peerInfoVector.size(); i++) {
				...
				System.out.println("Start remote peer " + pInfo.remotePeerID +  " at " + pInfo.remotePeerAddrs );
				
				// *********************** IMPORTANT *************************** //
				// If your program is JAVA, use this line.
				
				Runtime.getRuntime().exec("ssh " + pInfo.remotePeerAddrs + " cd " + path + "; java peerProcess " + pInfo.remotePeerID);
